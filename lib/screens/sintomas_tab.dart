    ...
    return ListView(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: "+ Añadir ejercicio personalizado (natación, bici…)",
            hintStyle: const TextStyle(color: Colors.grey),
            suffixIcon: IconButton(
              icon: Icon(Icons.add, color: _cc),
            ...
            child: Column(
              children: todaysActivity.map((a) {
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.fitness_center, color: _cc, size: 16),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
                      ...
                      IconButton(
                        ...
                        constraints: const BoxConstraints(),
                        onPressed: () {
                          setState(() => _p.activityHistory.remove(a));
                          widget.onProfileChanged();
                        },
                      ),
                    ],
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Esfuerzo: $effort/10",
                      style: TextStyle(color: _cc, fontWeight: FontWeight.bold, fontSize: 12)),
                  Slider(
                  ...
                  Text("Cómo me sentí: $feeling/5",
                      style: TextStyle(color: _cc, fontWeight: FontWeight.bold, fontSize: 12)),
                  Text(feelingLabel(feeling), style: const TextStyle(color: Colors.grey, fontSize: 11)),
                  Slider(
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      setState(() => _p.activityHistory.add(ActivityEvent(
                            timestamp: ts,
                            name: ex.name,
