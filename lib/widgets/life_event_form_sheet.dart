      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(isEdit ? "EDITAR EVENTO" : "REGISTRAR EVENTO",
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: Text("Inicio: ${DateFormat('d MMM yyyy').format(_startDate)}",
              ...
              if (_endDate != null) ...[
                ...
                Align(
                  ...
                  child: TextButton(
                    ...
                    child: Text("quitar fecha de fin",
              ...
              Wrap(
                ...
                children: kLifeEventCategorySuggestions.map((cat) {
                  final isSelected = _categoryCtrl.text.trim().toLowerCase() == cat;
                  return InkWell(
              ...
              ElevatedButton(
                ...
                onPressed: _save,
                child: Text(isEdit ? 'GUARDAR CAMBIOS' : 'REGISTRAR EVENTO',
