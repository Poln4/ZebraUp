...
Capas tipadas de profundidad clínica creciente. Cobertura actual: 5 de 6 síntomas planeados (83%).
...
Pendientes (backlog): D.5 (Dolor torácico — múltiples red flags esperadas).
